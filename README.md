...
├── App.tsx                    # Root navigation & theme provider
├── app.json                   # Expo configuration
├── screens/
│   ├── HomeScreen.tsx         # MoodBoard screen (picker & quote display)
│   └── HistoryScreen.tsx      # Mood history timeline
├── components/
│   ├── MoodCard.tsx           # Individual emoji mood card
│   ├── MoodGrid.tsx           # Grid layout for mood cards
│   ├── MoodDisplay.tsx        # Selected mood banner & quote display
│   ├── HistoryList.tsx        # FlatList displaying past mood entries
│   ├── ThemeToggle.tsx        # Dark / light mode toggle switch
│   └── ui/                    # Reusable UI primitives (icons, tabs)
├── context/
│   └── mood-context.tsx       # Mood state, history list, and theme context
├── constants/
